...
void calculate_esc_output () {
  ...
  if (start == 2) {                                                         //The motors are started.
    ...
    if (esc_1 > 1900) esc_1 = 1900;                                          //Limit the esc-1 pulse to 2000us.
    if (esc_2 > 1900) esc_2 = 1900;                                          //Limit the esc-2 pulse to 2000us.
    if (esc_3 > 1900) esc_3 = 1900;                                          //Limit the esc-3 pulse to 2000us.
    if (esc_4 > 1900) esc_4 = 1900;                                          //Limit the esc-4 pulse to 2000us.
  } else {
